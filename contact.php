    ...
    <div class="container py-2 bg-beige rounded-4">
      ...
      <footer class="d-none d-md-block text-center mt-2">
        <div class="bg-mauve rounded-4 col-md-10 col-lg-8 col-xl-6 mx-auto ">
          ...
          <a class="nav-item btn text-white btn-floating m-1" style="background-color: black" href="#!" role="button">
          ...
          <a class="nav-item btn text-white btn-floating m-1" style="background-color: #dd4b39" href="#!" role="button">
