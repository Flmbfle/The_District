...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Récupérez l'ID du plat depuis la requête GET
    ...
    // Chemin absolu vers l'image du plat du serveur
            ...
            <body style='padding: 1px; font-style: 1rem;' class='d-flex justify-content-center shadow'>
                ...
                <div class='container shadow rounded-3'>
                    ...
                    <main>
                        ...
                        <p class='fs-5 m-4'> Bonjour <br><br> Nous vous remercions pour votre visite. <br><br> Voici le récapitulatif de votre commande : </p>
                    ...
                    <footer class='col-10 text-center mx-auto' style='margin-top: 20%'>
                        <p> Conformément au règlement sur la protection des données n°2016/679 et à la loi informatique et libertés n°78-17 du 6 janvier 1978 modifiée, les informations recueillies font l’objet d’un traitement informatique et sont enregistrées dans un fichier informatisé par TheDistrict France Services, responsable de traitement, dans le cadre de son activité de restauration et de gestion de la base de ses clients et prospects. Nous collectons ainsi des données vous concernant lorsque vous fréquentez nos restaurants, utilisez nos sites Internet ou nos applications mobiles (les « services en ligne ») ou interagissez de toute autre manière avec nous. </p>
                    </footer>
